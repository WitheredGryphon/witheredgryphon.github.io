	...
	event.waitUntil(
    	caches.open(version + '-cache').then(function(cache) {
        	...
        	[
				...
				'/sites/vn_temp/images/fault_milestone_one_thumb.png',
				...
				'/sites/vn_temp/images/kara_no_shojo_thumb.png',
				...
				'/sites/vn_temp/images/muv_luv_alternative_thumb.png',
				'/sites/vn_temp/images/muv_luv_thumb.png',
				'/sites/vn_temp/images/my_girlfriend_thumb.png',
