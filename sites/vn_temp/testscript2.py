...
import csv
data = []
with open('Novels.csv') as csvDataFile:
...
for m in range(1, len(data)):
	...
	r3Name = data[m][41]
	r3URL = data[m][42]
	finalHTML.append(HTML_16x9[38])
	finalHTML.append(r1URL)
	finalHTML.append(HTML_16x9[39])
	finalHTML.append(r1Name)
	finalHTML.append(HTML_16x9[40])
	finalHTML.append(r2URL)
	finalHTML.append(HTML_16x9[41])
	finalHTML.append(r2Name)
	finalHTML.append(HTML_16x9[42])
	finalHTML.append(r3URL)
	finalHTML.append(HTML_16x9[43])
	...
	finalHTML.append(HTML_16x9[45])
	finalHTML.append(r1URL)
	finalHTML.append(HTML_16x9[46])
	finalHTML.append(r1Name)
	finalHTML.append(HTML_16x9[47])
	finalHTML.append(r2URL)
	finalHTML.append(HTML_16x9[48])
	finalHTML.append(r2Name)
	finalHTML.append(HTML_16x9[49])
	finalHTML.append(r3URL)
	finalHTML.append(HTML_16x9[50])
	finalHTML.append(r3Name)

	finalHTML.append(HTML_16x9[51])
	for i in range(len(stores)):
		if i == len(stores) - 1:
			finalHTML.append(stores[i] + "_button.png' style='width: 100%;'></a></div>")
			break
